...
### GPU Machine
If you do not already have access to GPUs, you may need to setup access to one.
While this is completely up to you it will be significantly simpler for you if you opt for a machine that has Ubuntu flavored OS. It is absolutely possible to work with other environments but it may cause issues you would have to deal with.
One option that has been battle-tested in the past is an AWS virtual machine.
[Here are the instructions for setting that up.](https://docs.google.com/presentation/d/1Qu6EiqSaAQQif5n6vN76riMXCEHKq6al9212TWrZwyY/edit?slide=id.p#slide=id.p)
